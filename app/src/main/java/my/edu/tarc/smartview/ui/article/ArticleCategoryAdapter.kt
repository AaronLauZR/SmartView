...
class ArticleCategoryAdapter(private val categories: List<String>, private val listener: IArticleCategoryAdapter): RecyclerView.Adapter<ArticleCategoryAdapter.CategoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.categoryName.setOnClickListener {
            ...
            listener.onArticleCategoryClicked(categories[position])
    ...
    interface IArticleCategoryAdapter{
        fun onArticleCategoryClicked(category: String)
    }
}